enyo.kind({
    ...
    statics: {
        ...
        // Known good Smooth Streaming URL
        sampleVideosBasePath: "",
        sampleVideos: [
            "http://streams.smooth.vertigo.com/BigBuckBunny/Big%20Buck%20Bunny.ism/manifest"
        ],
        sampleVideoHash: {
            "fake": "no-url"
        },

        // // External HLS test videos
        // sampleVideosBasePath: "",
        // sampleVideos: [
        //     "https://d1lcg0vci8qqw3.cloudfront.net/H8A7BUWZ/7A5CQKUQK1BC/m3u8/7A5CQKUQK1BC.m3u8",
        //     "https://d1lcg0vci8qqw3.cloudfront.net/H8A7BUWZ/GAL8PAF73M1G/m3u8/GAL8PAF73M1G.m3u8",
        //     "https://d1lcg0vci8qqw3.cloudfront.net/H8A7BUWZ/3PTZODNNBKO8/m3u8/3PTZODNNBKO8.m3u8"
        // ],
        // sampleVideoHash: {
        //     "fake": "no-url"
        // },
        ...
        // // Local videos
        // sampleVideosBasePath: "assets/sampleVideos/",
        // sampleVideos: [
        ...
        // sampleVideoHash: {
        //     // Top Picks
        //     "91504147035063534": "GoPro- Diving With Giant Manta Rays.mp4",
        //     "89949621807220126": "GoPro- Drainage Ditch Kayaking.mp4",
        //     "86219930894074938": "GoPro- Crazy Breakdancer.mp4",
        //     "86533256685552701": "GoPro- Shark Feeding with Andy Casagrande in 2.7K 3D.mp4",
